...
class TestSecretDecryption:
    ...
    def _capture_crawl_decryptors(self, azure_ds, sources):
        """Run crawl_metadata over ``sources`` and capture the decryptor.
    ...
    def test_decrypted_custom_data_survives_reboot_read(self):
        """Cached plaintext CustomData decodes on reboot without decryptor."""
